# Generated by Django 2.0.3 on 2018-03-29 20:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='demand',
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.DemandType', verbose_name='需求类型'),
        ),
        migrations.AddField(
            model_name='demand',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.Profile', verbose_name='发布者'),
        ),
        migrations.AddField(
            model_name='auth',
            name='profile',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.Profile', verbose_name='认证用户'),
        ),
    ]
